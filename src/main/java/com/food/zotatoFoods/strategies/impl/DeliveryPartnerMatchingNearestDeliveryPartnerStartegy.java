...
public class DeliveryPartnerMatchingNearestDeliveryPartnerStartegy implements DeliveryPartnerMatchingStrategy {

    private final DeliveryPartnerRepository deliveryPartnerRepository;

    @Override
    public List<DeliveryPartner> findMatchingDeliveryPartner(DeliveryFareGetDto deliveryFareGetDto) {
        return deliveryPartnerRepository.findTenNearByDeliveryPartner(deliveryFareGetDto.getPickupLocation());
    }
